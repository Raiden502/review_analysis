...
def phase1():
    # Loading the dataset
    food_data = pd.read_csv(r'./food_review_prediction/dataset/Reviews.csv')
...
def phase2(a, b):
    ...
    pickle.dump(vect, open("./food_review_prediction/output/vector.pkl", 'wb'))
    ...
    pickle.dump(model1, open("./food_review_prediction/output/model.pkl", 'wb'))
